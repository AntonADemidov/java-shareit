...
public class ItemRequestClient extends BaseClient {
    ...
    public ResponseEntity<Object> createItemRequest(Long userId, ItemRequestDtoFromUser itemRequestDtoFromUser) {
        return post("", userId, itemRequestDtoFromUser);
    }
    ...
    public ResponseEntity<Object> getItemRequestById(Long userId, Long id) {
        return get(String.format("/%s", id), userId);
    }
}